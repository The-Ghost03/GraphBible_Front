...
// Variantes statiques — plus de fonctions dynamiques qui peuvent échouer
const fadeUp = {
  hidden: { opacity: 0, y: 20 },
  show:   { opacity: 1, y: 0,  transition: { duration: 0.5, ease: "easeOut" } },
};
const fadeUp1 = { hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0, transition: { duration: 0.5, ease: "easeOut", delay: 0.1 } } };
const fadeUp2 = { hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0, transition: { duration: 0.5, ease: "easeOut", delay: 0.2 } } };
const fadeUp3 = { hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0, transition: { duration: 0.5, ease: "easeOut", delay: 0.3 } } };
...
export default function Landing() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#fff", color: "#0f172a", fontFamily: "sans-serif", overflowX: "hidden" }}>
      {/* NAV */}
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white">
        ...
        <div className="relative max-w-6xl mx-auto px-4 pt-20 pb-24 text-center">
          <motion.div variants={fadeUp} initial="hidden" animate="show" className="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-500/30 text-blue-300 text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
            <Sparkles className="w-3.5 h-3.5" />
            Accès 100% gratuit · Aucune carte bancaire requise
          </motion.div>
          <motion.h1 variants={fadeUp1} initial="hidden" animate="show" className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-6">
            Étudiez la Bible.<br />
            <span className="text-blue-400">Visualisez les connexions.</span>
          </motion.h1>
          <motion.p variants={fadeUp2} initial="hidden" animate="show" className="text-slate-300 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <motion.div variants={fadeUp3} initial="hidden" animate="show" className="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map((f, i) => {
              const Icon = f.icon;
              return (
                <motion.div key={f.title} variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="p-6 rounded-2xl border border-slate-100 hover:border-slate-200 hover:shadow-md transition-all bg-white">
      ...
      <section id="comment-ca-marche" className="py-24 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {STEPS.map((s, i) => (
              <motion.div key={s.n} variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="relative text-center">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={fadeUp1} initial="hidden" whileInView="show" viewport={{ once: true }} className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-8 text-white text-center shadow-xl shadow-blue-200">
